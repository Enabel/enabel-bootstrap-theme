        ...
        t.exports = (function () {
          ...
          class at extends z {
            ...
            _setActiveIndicatorElement(t) {
              ...
              i &&
                (i.classList.add(nt), i.setAttribute("aria-current", "true"));
            }
            _updateInterval() {
          ...
          P.on(document, "click.bs.collapse.data-api", ut, function (t) {
            ("A" === t.target.tagName ||
                ...
                var s =
                    "clippingParents" === e
                      ? (function (t) {
                          var e = Ce(ne(t)),
                            i =
                              ["absolute", "fixed"].indexOf(te(t).position) >=
                                0 && zt(t)
                                ? oe(t)
                                : t;
                          return Ft(i)
          ...
          var ze = Fe(),
            qe = Fe({ defaultModifiers: [me, je, pe, Rt] }),
            Re = Fe({ defaultModifiers: [me, je, pe, Rt, Pe, De, Me, he, Ne] });
          ...
          class pi {
            ...
            hide() {
              ...
              this._disableOverFlow(),
                ...
                this._setElementAttributes(hi, di, (e) => e + t),
                this._setElementAttributes(ui, fi, (e) => e - t);
            }
            reset() {
              this._resetElementAttributes(this._element, "overflow"),
                this._resetElementAttributes(this._element, di),
                this._resetElementAttributes(hi, di),
                this._resetElementAttributes(ui, fi);
            }
            isOverflowing() {
          ...
          class Ii extends z {
            ...
            show(t) {
              this._isShown ||
                ...
                P.trigger(this._element, Oi, { relatedTarget: t })
                  .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
          ...
          P.on(
            ...
            P.on(window, "load.bs.offcanvas.data-api", () => {
              for (const t of Q.find(Mi)) Fi.getOrCreateInstance(t).show();
            }),
          ...
          const zi = new Set([
            ...
            Vi = (t, e) => {
              ...
              return e.includes(i)
                ? !zi.has(i) ||
                    Boolean(qi.test(t.nodeValue) || Ri.test(t.nodeValue))
          ...
          class _n extends z {
            ...
            _maybeEnableSmoothScroll() {
              this._config.smoothScroll &&
                ...
                P.on(this._config.target, dn, pn, (t) => {
